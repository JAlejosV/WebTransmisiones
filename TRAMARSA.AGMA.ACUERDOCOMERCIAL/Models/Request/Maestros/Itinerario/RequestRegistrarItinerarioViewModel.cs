...
{
    public class RequestRegistrarItinerarioViewModel : RequestBaseDTO
    {
        ...
        //public string HoraArriboItinerario { get; set; }
        //public string FechaZarpeItinerario { get; set; }
        //public string HoraZarpeItinerario { get; set; }
        //public string FechaAtraqueItinerario { get; set; }
        //public string HoraAtraqueItinerario { get; set; }
        //public string FechaTerminoDescargaItinerario { get; set; }
        //public string HoraTerminoDescargaItinerario { get; set; }
        ...
        //public string FechaZarpePuertoIntermedio { get; set; }
        //public string HoraZarpePuertoIntermedio { get; set; }
